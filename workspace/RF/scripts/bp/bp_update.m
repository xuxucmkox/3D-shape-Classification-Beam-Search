...
model.layers{numLayer}.histw = momentum * model.layers{numLayer}.histw + lr /5  * (model.layers{numLayer}.grdw + wd * model.layers{numLayer}.w);
model.layers{numLayer}.histc = momentum * model.layers{numLayer}.histc + lr /5  * model.layers{numLayer}.grdc;
